    ...
    <div className="liquidity-box">
      <div className="odd title">Provide { bToken } Earn DERI</div>
				...
				<div className="title-check">
				 ...
				 <Operator wallet={wallet} chainId={chainId} address={address} liqInfo={liquidity} baseToken={bToken} loadLiquidity={loadLiquidityInfo} isLpPool={isLpPool} loadLiqidityInfo={loadLiquidityInfo}/>
	</div>
  )
}
