...
export default function RechartArea({title,url}){
  ...
  return (
    // <ResponsiveContainer >
      <AreaChart height={250} width={parentRect.width} data={data}>
        <defs>
      ...
      <Tooltip position={{x : 0,y : 0}} cursor={false} content={<CustomTooltip title={title}/>}/>
      <Area type="monotone" dataKey="value" stroke="#00659f" fillOpacity={0.9} fill="url(#colorArea)" />
    </AreaChart>
  // </ResponsiveContainer>
  )
}