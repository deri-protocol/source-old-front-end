...
function Pool({lang,loading,wallet}){
  const [loaded,pools,v1Pools,v2Pools,optionPools] = useMiningPool(true,wallet);
  ...
  return (
    <div className="mining-info">
      ...
      {curStyle === 'list' ? <List optionPools={optionPools} v1Pools={v1Pools} v2Pools={v2Pools} lang={lang} wallet={wallet}/> : <Card  type={curTab} optionPools={optionPools} v1Pools={v1Pools} v2Pools={v2Pools} lang={lang}/>}
    </div>
  )
}
