    ...
    <div className="nav-menu">
      ...
      <div className="mean">
        <ul>
          ...
          <li><Link to='/lite' className={isLite || isPro ? 'selected' : ''}>{lang.trade}</Link></li>
          <li>
            <a target="_blank" rel='noreferrer' href="https://governance.deri.finance/">{lang.governance}</a>
          </li>
          <li>
            <a target="_blank" rel='noreferrer' href="https://bridge.deri.finance/">{lang.bridge}</a>
          </li>
          <li className="ref">
