...
describe('utils', () => {
  ...
  test('getOracleUrl()', () => {
    const [input, output] = [['97','0xFFe402106E8F73F0A44C7350C2b734e048f448f2'], 'https://oracle4.deri.finance/price?symbol=BTCUSD'];
    expect(getOracleUrl(...input)).toEqual(output);
    DeriEnv.set('prod')
    const [input2, output2] = [['56','0x639a9C2fAe976D089dCcc2ffAE51Ef1dd04B7985'], 'https://oracle4.deri.finance/price?symbol=BTCUSD'];
