...
describe('EverlastingOptionViewer', () => {
  ...
  it(
    ...
    async () => {
      ...
      expect(res.poolState).toHaveProperty('pool', '0x33eeDeC1DF73d0F93E126D80aCfEb005162cd242')
      ...
      expect(res.symbolState[0]).toHaveProperty('volatilityAddress', '0xA221f3BCf5cB39412F2689Fed22dfA59031aE71B')
