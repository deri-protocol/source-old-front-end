...
describe('EverlastingOptionViewer', () => {
  ...
  it(
    ...
    async () => {
      ...
      expect(res.poolState).toHaveProperty('pool', '0xC6E1C0d4D7DcEd21702FCAB7E7915D3804308546')
      expect(res.poolState).toHaveProperty('pToken', '0x67eBB9e3dcd1982E6B0D09b398fA9d7FA1852EEb')
      expect(res.poolState).toHaveProperty('pmmPricer', '0x353Ec542F02AF324023C552a31B1083C8359238B')
      expect(res.poolState).toHaveProperty('optionPricer', '0x01Be69975Bba27b6D4d4be750aB3B0DEF8ace805')
      ...
      expect(res.symbolState[0]).toHaveProperty('alpha', '10000000000000000')
