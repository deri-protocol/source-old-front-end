...
describe('EverlastingOptionViewer', () => {
  ...
  it(
    ...
    async () => {
      ...
      expect(res.poolState).toHaveProperty('pool', '0xB6432C75c33182523e7Ee642e794CC88083b7034')
      ...
      expect(res.symbolState[0]).toHaveProperty('volatilityAddress', '0x4E7506086457399C6ab5acBc146d3A2eBD26380f')
